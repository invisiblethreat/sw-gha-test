...
import {tag as epochBuildTag} from '../support/epoch-build';
import cliOpts from '../support/protractor/cli-opts';
import {waitTime} from '../support/protractor/time';

const config = {
    baseUrl: 'https://qa.epoch.io',

    sauceUser: 'epochdev',
    sauceKey: '0017e418-d36e-4b3b-bac7-b9527dfb24be',
    sauceBuild: epochBuildTag ? epochBuildTag : null,
