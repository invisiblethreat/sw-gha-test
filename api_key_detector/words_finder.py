...
def filter_characters(string, invalid_chars: str = INVALID_CHARS) -> str:
    """
...
class WordsFinder:
    ...
    def __init__(self, wordlists: List):
    ...
    def get_words_indexes(self, string: str) -> Iterable[Tuple[int, int, str]]:
        """
    ...
    def get_words_percentage(self, string: str) -> float:
        """
