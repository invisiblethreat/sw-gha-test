...
def send_test_status(status):
    ...
    status_obj = {}
    if status == "FAIL":
        status_obj = {"job": "update-demo", "result": "FAIL", "jenkins_build_url": "https://jenkins.company.io/job/upgrade-demo/" + BUILD_NUMBER + "/console"}
    elif status == "PASS":
        status_obj = {"job": "update-demo", "result": "PASS", "jenkins_build_url": "https://jenkins.company.io/job/upgrade-demo/" + BUILD_NUMBER + "/console"}
