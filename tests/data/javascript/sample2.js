var registrationProduct = registrationProduct || (function () {
    ...
    function requestLicense(event) {
        ...
        .fail(function(err, statusText) {
            ...
            if (err.status === 401) {
                msg = 'You have an existing Product account.<br>Please <a href="https://lm.product.company.com" target="_blank">login</a> to generate your license key.';
                isHtml = true;
            }
